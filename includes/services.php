<!-- Services content -->
<div class="services px-4 pb-5">
    <h2 class="ml-5 mb-4"><b>Nos <span class="blue">Services</span></b></h2>
    <div class="d-flex flex-wrap justify-content-around align-items-center w-100">
        ...
        <div class="card-services card shadow rounded-0 my-3">
            <div class="card-body text-center">
                <div class="circle-services d-flex align-items-center justify-content-center"><i id="icons-services" class="fas fa-eye"></i></div><br>
                <h4 class="font-weight-bold">Référencement</h4><br>
                <p>Nous vous aidons à mettre en valeur votre site internet pour plus de visibilité.</p>
                <p></p>
            </div> 
        </div>
        <div class="card-services card shadow rounded-0 my-3">
